...
<template>
  <div class="flex-1 flex">
    <div class="bg-base-100 transition-all duration-300 shink-0" :class="{ 'w-64': isSidebarOpen, 'w-16': !isSidebarOpen }">
      <div
        class="hover:cursor-pointer hover:bg-base-200 p-2 flex"
